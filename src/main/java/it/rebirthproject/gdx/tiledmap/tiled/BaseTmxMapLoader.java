...
import it.rebirthproject.gdx.tiledmap.MapGroupLayer;
import it.rebirthproject.gdx.tiledmap.MapLayer;
import it.rebirthproject.gdx.tiledmap.MapLayers;
import it.rebirthproject.gdx.tiledmap.MapObject;
import it.rebirthproject.gdx.tiledmap.MapObjects;
import it.rebirthproject.gdx.tiledmap.MapProperties;
import it.rebirthproject.gdx.tiledmap.objects.EllipseMapObject;
import it.rebirthproject.gdx.tiledmap.objects.PointMapObject;
import it.rebirthproject.gdx.tiledmap.objects.PolygonMapObject;
import it.rebirthproject.gdx.tiledmap.objects.PolylineMapObject;
import it.rebirthproject.gdx.tiledmap.objects.RectangleMapObject;
import it.rebirthproject.gdx.tiledmap.objects.TextMapObject;
import it.rebirthproject.gdx.tiledmap.tiled.TiledMapTileLayer.Cell;
import it.rebirthproject.gdx.tiledmap.tiled.objects.TiledMapTileMapObject;
import it.rebirthproject.gdx.tiledmap.tiled.tiles.AnimatedTiledMapTile;
